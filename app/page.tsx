...
export default function HomePage() {
  return (
    <div className="flex w-full max-w-full min-w-0 flex-col overflow-x-clip">
      <section className="w-full max-w-full overflow-x-clip pt-16">
        <div className="relative h-[72svh] min-h-[420px] w-full max-w-full overflow-hidden bg-black sm:h-[calc(100svh-4rem)]">
          ...
          <div className="relative z-10 mx-auto flex h-full w-full max-w-7xl flex-col justify-end px-4 pb-8 sm:px-6 md:px-8 lg:px-10" />
        </div>
      </section>

      <section className="section-fade w-full max-w-full overflow-x-clip py-10">
      ...
      <section className="section-fade w-full max-w-full overflow-x-clip bg-secondary/30 py-24 lg:py-32">
        <div className="mx-auto w-full max-w-7xl px-4 lg:px-8">
      ...
      <section className="section-fade w-full max-w-full overflow-x-clip py-20 lg:py-24">
      ...
      <section className="section-fade w-full max-w-full overflow-x-clip py-24 lg:py-32">
        <div className="mx-auto w-full max-w-7xl px-4 lg:px-8">
