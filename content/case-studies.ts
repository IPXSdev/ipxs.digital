...
export const caseStudies: CaseStudy[] = [
  {
    ...
    outcomeLine: 'End to end creative assets for the Charlie BeReal single release of the song Chocolate Woman on Death Row Records, including primary artwork, animated cover motion, and rollout assets tailored for streaming and social launch windows.',
...

  {
    ...
    media: [
      ...
      { id: 'let-the-record-cover', type: 'image', src: '/case-studies/pitch-decks/covers/let-the-record-play.png', poster: '/case-studies/pitch-decks/covers/let-the-record-play.png', alt: 'Let The Record Play podcast pitch deck cover', caption: 'DECK 03 — Let The Record Play: This deck sells a live podcast and YouTube format by making the structure the hook. It is framed as a three act immersive experience. The narrative emphasizes why the show matters for deep engagement across audio and video audiences, with clear sponsor alignment language and location credibility tied to Delicious Vinyl and West Adams.' },
      { id: 'dynamics-cover', type: 'image', src: '/case-studies/pitch-decks/covers/dynamics-multiverse.jpg', poster: '/case-studies/pitch-decks/covers/dynamics-multiverse.jpg', alt: 'The Dynamics Multiverse web3 pitch deck cover', caption: 'DECK 04 — The Dynamics Multiverse: This deck presents IPXS as a proprietary licensing protocol that connects IP ownership to smart licensing contracts, enabling licensing and on demand commerce backed by on chain eligibility verification. The deck is built to translate technical utility into a clear end user flow and monetization narrative.' },
    ],
    credits: defaultCredits,
  },
