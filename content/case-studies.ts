...
export const caseStudies: CaseStudy[] = [
  {
    ...
    media: [
      { id: 'chocolate-woman-cover', type: 'image', src: '/case-studies/charlibereal-deathrow-campaign/chocolate-woman-cover.jpg', poster: '/case-studies/charlibereal-deathrow-campaign/chocolate-woman-cover.jpg', alt: 'Chocolate Woman album cover featuring Statue of Liberty inspired artwork', caption: 'Primary cover art for Chocolate Woman single.' },
      { id: 'chocolate-woman-motion', type: 'video', src: '/case-studies/charlibereal-deathrow-campaign/chocolate-woman-motion.mp4', poster: '/case-studies/charlibereal-deathrow-campaign/chocolate-woman-cover.jpg', alt: 'Chocolate Woman animated motion piece', caption: 'Motion animation for social and streaming placements.' },
      { id: 'together-cover', type: 'image', src: '/case-studies/charlibereal-deathrow-campaign/together-cover.png', poster: '/case-studies/charlibereal-deathrow-campaign/together-cover.png', alt: 'Together album cover with psychedelic heart design', caption: 'Cover art for Together single release.' },
